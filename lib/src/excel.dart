// ignore_for_file: prefer_typing_uninitialized_variables, type_annotate_public_apis, prefer_final_locals, avoid_multiple_declarations_per_line, noop_primitive_operations, avoid_setters_without_getters
...
class Excel {
  ...
  factory Excel.createExcel() {
    ...
    return Excel.decodeBytes(const Base64Decoder().convert(newSheet));
  }
  ...
  void delete(String sheet) {
    ...
    if (_xmlSheetId[sheet] != null) {
      String sheetId1 =
              "worksheets${_xmlSheetId[sheet].toString().split('worksheets')[1]}",
